> **MANDATORY**: You must abide by the universal rules in .agent/rules/GEMINI.md at all times.
...
model: inherit
skills: clean-code, parallel-agents, behavioral-modes, plan-writing, brainstorming, architecture, lint-and-validate, powershell-windows, bash-linux, caveman
---
